...
export default function ElevenFileDesignFive() {
  const descriptions = [
    {
      id: 1,
      ...
      <div className="border border-gray-400">
        ...
        <div className="text-center p-4">
          ...
          <p className="text-lg font-bold">
            (Π.Δ. 305/96, άρθρο 3 - παρ. 3, 7, 8, 9, 10, 11)
          </p>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              <span className="font-medium">
                ΥΠΟΧΡΕΟΣ ΓΙΑ ΤΗΝ ΕΚΠΟΝΗΣΗ ΤΟΥ Σ.Α.Υ. :
              </span>
              <div className="flex flex-col items-center justify-center">
                <span className="flex-1  font-bold">
                  NAME AND SURNAME ENGINEER
                </span>
        ...
        <div className="p-4">
          ...
          <div className="mb-4">
            ...
            <p className="mb-2">
              Για την κατασκευή του κτιρίου χρειάστηκε να γίνουν οι παρακάτω
              μελέτες:
            </p>
            <div className="space-y-1 text-sm">
              ...
              <div className="text-[#008000]">
                9. Μελέτη Ενεργειακής Απόδοσης
              </div>
              <div className="text-[#008000]">10. Τοπογραφικό</div>
            </div>
            <p className="mt-2 text-sm">
              Θα προσαρτηθούν στο Φ.Α.Υ. με τη μορφή παραρτήματος τα "ως
              κατασκευάστηκε" σχέδια του έργου, μετά την ολοκλήρωση της
              εκτέλεσής του.
            </p>
          </div>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="space-y-2 text-sm">
            <p>
              Δεν υπάρχουν ζώνες ιδιαίτερου κινδύνου στο εργοτάξιο της
              οικοδομής.
            </p>
            <p>
              Δεν υπάρχουν ιδιαιτερότητες στη στατική δομή, ευστάθεια και αντοχή
              του έργου.
            </p>
            <p>
              Θέσεις δικτύων κεντρικών παροχών και κεντρικών διακοπτών θα
              σημανθούν.
            </p>
            <p>
              Θέσεις εξόδων κινδύνου και πυροσβεστικές φωλεές θα επισημανθούν.
            </p>
          </div>
        ...
        <div className="p-4">
          ...
          <div className="space-y-2 text-sm">
            <p>
              Οι εργασίες συντήρησης και καθαρισμού των εξωτερικών τμημάτων της
              οικοδομής και τυχόν φωταγωγών που απαιτούν τη χρήση ικριωμάτων θα
              γίνουν από εξειδικευμένα συνεργεία με λήψη των αναγκαίων μέτρων
              προστασίας βάσει των ισχυουσών διατάξεων.
            </p>
            <p>
              Η συντήρηση των δικτύων διανομής ηλεκτρικού ρεύματος θα γίνεται σε
              τακτά χρονικά διαστήματα μόνο από εξειδικευμένους τεχνίτες,
          ...
          <div className="mt-6 text-right">
            <div className="flex justify-between items-start">
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                <span className="text-[#008000]">6/8/2025</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-gray-400">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <span className="font-medium">ΕΡΓΟ :</span>
              <span className="flex-1 text-[#008000] font-bold">
                PROJECT DESCRIPTION
              </span>
            </div>
        ...
        <div className="p-4">
          <div className="mb-4">
            <h3 className="font-medium mb-2 underline">
              PROJECT WORKS FOR TECHNICAL DESCRIPTION
            </h3>
            <div className="mb-2">
              {/* Mapping over the fetched data */}
        ...
        <div>
          ...
          <div className="p-3 border-b border-gray-400 text-sm">
            Η συγκεκριμένη κατασκευή δεν μπορεί να θεωρηθεί ιδιαίτερα επικίνδυνη
            κατά την εκτέλεση των διάφορων φάσεων των έργων. Οι πιθανότεροι
            κίνδυνοι είναι:
          </div>

          <div className="border-b border-gray-400">
            <div className="grid grid-cols-12">
              <div className="col-span-1 border-r border-gray-400 p-2 text-center font-bold text-[#008000]">
                #REF!
              </div>
              <div className="col-span-11 p-2 text-sm">
                Πιθανός κίνδυνος πτώσεως εργαζομένων από ύψος στις εργασίες
                κατασκευής ξυλοτύπων, σκυροδέτησης, τοποθέτησης σιδηροπλισμών,
                κατασκευής τοιχοδομών και επιχρισμάτων, χρωματισμών κτλ.
              </div>
            </div>
          </div>
          ...
          <div className="border-b border-gray-400">
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-11 p-2 text-sm">
                Πιθανός κίνδυνος πτώσεως αντικειμένων και υλικών.
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="border-y border-gray-400">
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-11 p-2 text-sm">
                • Για να προλαμβάνονται οι πτώσεις εργαζομένων ή αντικειμένων
                πρέπει σε όλες τις εργασίες η κατασκευή των ικριωμάτων πρέπει να
                είναι η σωστή και να πληρεί τις προδιαγραφές της κείμενης
                νομοθεσίας (ΠΔ 778/80 και 1073/81), να τοποθετούνται
                κιγκλιδώματα και κατάλληλες περιφράξεις στους διαδρόμους των
                ικριωμάτων, του κτιρίου κλπ. στις σκάλες και φρεάτια ασανσέρ,
                στα πρανή των εκσκαφών και στις οπές του κτιρίου.
              </div>
            </div>
          </div>
          ...
          <div className="border-b border-gray-400">
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-11 p-2 text-sm">
                • Οι εργαζόμενοι πρέπει να φορούν τα προβλεπόμενα από τη
                νομοθεσία κράνη, να διαθέτουν την κατάλληλη ένδυση και υπόδηση
                προς αποφυγή ολισθήσεων και ηλεκτροπληξιών. Σε ορισμένες
                εργασίες να διατίθενται ζώνες ασφαλείας και να προσδένονται οι
                εργαζόμενοι.
              </div>
            </div>
          </div>
        ...
        <div className="p-4">
          <div className="font-bold mt-12">Δ. ΠΡΟΣΘΕΤΑ ΣΤΟΙΧΕΙΑ</div>
          <div className="space-y-2 text-sm mt-4">
            <p>
              1. Προσπέλαση στο εργοτάξιο, πρόσβαση στις θέσεις εργασίας: <br />
              <span className="p-4">
                Δεν απαιτείται ιδιαίτερη μέριμνα πέραν των συνηθισμένων.
              </span>
            </p>
            <p>
              2. Κυκλοφορία οχημάτων και πεζών εντός του εργοταξίου: <br />
              <span className="p-4">
                Δεν απαιτείται ιδιαίτερη μέριμνα πέραν των συνηθισμένων.
              </span>
            </p>
            <p>
              3. Χώροι αποθήκευσης υλικών και τρόπος αποκομιδής αχρήστων: <br />
              <span className="p-4">Αποθήκευση στον ακάλυπτο χώρο της οικοδομής και αποκομιδή αχρήστων
              με μηχανικά μέσα.</span>
            </p>
            <p>
              4. Συνθήκες αποκομιδής επικίνδυνων υλικών: <br />
             <span className="p-4"> Δεν θα χρησιμοποιηθούν επικίνδυνα υλικά.</span>
            </p>
            <p>
              5. Χώροι υγιεινής, εστίασης και πρώτων βοηθειών: <br />
             <span className="p-4"> Θα δημιουργηθεί πρόχειρο W.C. και φαρμακείο στο ισόγειο.</span>
            </p>
            <p>
              6. Κατασκευή ικριωμάτων: <br />
             <span className="p-4">Συνήθους μορφής βάσει Π.Δ. 778/80 και Π.Δ. 1073/81.</span>
            </p>
          </div>
        </div>
