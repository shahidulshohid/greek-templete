...
export default function ElevenFileDesignElEven() {
  return (
    <div className="max-w-[794px] mx-auto p-4 bg-white">
      ...
      <div className="border border-gray-400">
        ...
        <div className="p-4 text-sm ">
          <p className="">
            μετά από αυτοψία και έλεγχο των τοπογραφικών στοιχείων της περιοχής,
            βεβαιώνω ότι το γήπεδο/οικόπεδο που βρίσκεται στη θέση: <br />
            Address, Town/Area , postal code ( FOR BUILDING)
            <span className="font-semibold">
              απέχει σε ευθεία απόσταση μεγαλύτερη των 500 μέτρων από τη γραμμή
              αιγιαλού / θάλασσα.
            </span>
          </p>
          <p className="mt-3">
           Η εκτίμηση της απόστασης έγινε βάσει:Τοπογραφικού διαγράμματος,Μετρήσεων με χρήση γεωχωρικών εργαλείων (Google Earth ή GIS),Υφιστάμενων χαρτογραφικών δεδομένων,Επιτόπιας αυτοψίας
          </p>
          <p className="mt-3">
          Η παρούσα δήλωση αφορά την απαλλαγή από τις ειδικές απαιτήσεις της κείμενης νομοθεσίας που αφορούν έργα ή επεμβάσεις εντός ζώνης 500 μέτρων από τη θάλασσα.
          </p>
        </div>
