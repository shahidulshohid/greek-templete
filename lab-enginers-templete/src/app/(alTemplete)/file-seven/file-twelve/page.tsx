...
export default function FileSevenDesignTwelve() {
  return (
    <div className="max-w-[796px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm">
                    ...
                    <p className="mb-4 ">ότι εφαρμόζοντας τις ισχύουσες γενικές και ειδικές πολεοδομικές διατάξεις <span className="font-bold">αναλαμβάνω</span> για το έργο</p>
                ...
                {/* common component  */}
                <div className="flex items-center justify-end mt-6 pr-5">
                    <StampComponent />
                </div>
            </div>
        </div>
