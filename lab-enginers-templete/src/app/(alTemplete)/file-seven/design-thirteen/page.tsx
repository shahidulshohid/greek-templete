...
export default function FileSevenDesignThirteen() {
    return (
        <div className="max-w-[796px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="space-y-4 text-s m p-4 mb-10">
                    <p>
                        δεν προβλέπεται η παραγωγή αποβλήτων τύπου ΑΕΚΚ (Απόβλητα Εκσκαφών, Κατασκευών και Κατεδαφίσεων), καθώς οι προβλεπόμενες εργασίες δεν περιλαμβάνουν καθαιρέσεις, εκσκαφές ή κατασκευαστικές επεμβάσεις που να παράγουν απόβλητα ΑΕΚΚ.</p>
                </div>
                ...
                {/* common component  */}
                <div className="flex items-center justify-end pr-5 mt-6">
                    <StampComponent />
                </div>
            </div>
        </div>
