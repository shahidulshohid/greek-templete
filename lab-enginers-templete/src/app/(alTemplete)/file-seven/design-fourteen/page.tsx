...
export default function FileSevenDesignFourteen() {
  return (
       <div className="max-w-[796px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm">
                    ...
                    <p className="mb-4">
                       ως κύριος/ιδιοκτήτης του ακινήτου που βρίσκεται επί της οδού ([Address, Number, Town, Postal code],συναινώ ρητά και ανεπιφύλακτα στην έκδοση Έγκρισης Εργασιών Μικρής Κλίμακας για την εκτέλεση των  εργασιών,
                    </p>
                ...
                <div className="space-y-4 text-s m p-4">
                        <p>
                           Η παρούσα δήλωση παρέχεται αποκλειστικά για την κάλυψη των απαιτήσεων του άρθρου 29 του Ν.4495/2017 και των σχετικών κανονιστικών πράξεων.</p>
                </div>
