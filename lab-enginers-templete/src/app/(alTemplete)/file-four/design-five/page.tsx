...
export default function FileFourDesignFive() {
    return (
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm">
                    ...
                    <p className="mb-4">
                        ...
                        Postal code], αναθέτω στον/στην Διπλωματούχο Μηχανικό <span className="font-bold">( Engineers Surname  ,  Engineer's
                        Name, Specialty Engineer AM TEE)</span>
                    </p>
