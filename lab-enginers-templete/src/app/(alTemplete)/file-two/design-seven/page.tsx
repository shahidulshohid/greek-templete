...
export default function FileTwoDesignSeven() {
    return (
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm">
                    ...
                    <p className=" ">
                        ...
                        ([Address, Number, Town, Postal code], <span className="font-bold">αναθέτω</span> στον/στην Διπλωματούχο Μηχανικό
                        <span className="font-bold">( Engineers Surname  ,  Engineer's Name, Specialty Engineer AM TEE)</span>
                    </p>
                    <p className="font-bold mt-4"> για το έργο με τίτλο :</p>
