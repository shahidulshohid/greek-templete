...
export default function FileTwoDesignFour() {
    return (
        <div className="max-w-[794px] mx-auto p-4 bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm ">
                    <p className="mb-6">
                        <span className="font-bold">δεν προβλέπεται η παραγωγή αποβλήτων τύπου ΑΕΚΚ</span> (Απόβλητα Εκσκαφών,
                         Κατασκευών και Κατεδαφίσεων), καθώς οι προβλεπόμενες εργασίες δεν περιλαμβάνουν καθαιρέσεις, 
                         εκσκαφές ή κατασκευαστικές επεμβάσεις που να παράγουν απόβλητα ΑΕΚΚ.
                    </p>
                </div>
