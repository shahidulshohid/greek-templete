import StampComponent from "@/component/shared/dashed/Dashed";
  ...
  export default function FileFourteenDesignThreen() {
    return (
      <div className="max-w-[794px] mx-auto p-4 bg-white">
        ...
        <div className="border border-gray-400">
          ...
          <div className="p-4 text-sm space-y-2">
            <p>
            <span className="font-bold">ΔΕΝ επηρεάζεται, δεν τροποποιείται και δεν θίγεται,</span> καθ’ οιονδήποτε τρόπο ο φέρων οργανισμός (στατικός φορέας) του κτιρίου, και οι εργασίες δεν επιφέρουν καμία επιβάρυνση ή αλλαγή στα στατικά ή γεωμετρικά χαρακτηριστικά του φέροντος οργανισμού, όπως αυτά υφίστανται σύμφωνα με την υφιστάμενη Οικοδομική Άδεια.
