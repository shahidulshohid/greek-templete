import StampComponent from "@/component/shared/dashed/Dashed";
  ...
  export default function FileFourteenDesignFourteen() {
    return (
      <div className="max-w-[794px] mx-auto p-4 bg-white">
        ...
        <div className="border border-gray-400">
          ...
          <div className="p-4 text-sm">
            ...
            <p className="mt-4 mb-4">ως κύριος/ιδιοκτήτης του ακινήτου που βρίσκεται επί της οδού ([Address, Number, Town, Postal code],συναινώ ρητά και ανεπιφύλακτα στην έκδοση Έγκρισης Εργασιών Μικρής Κλίμακας για την εκτέλεση των  εργασιών,</p>
          ...
          <div className="p-4 text-sm space-y-2">
            ...
            {/* <p>Οι εργασίες θα εκτελεστούν σύμφωνα με τις ισχύουσες τεχνικές προδιαγραφές, τις ελάχιστες απαιτήσεις ασφάλειας και υγείας, καθώς και με πλήρη συμμόρφωση προς τις πολεοδομικές και λοιπές σχετικές διατάξεις.</p> */}
          </div>
