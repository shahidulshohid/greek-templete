...
export default function FileFiveDesignSix() {
    return (
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm">
                    ...
                    <p className="mb-4">
                        ...
                        ([Address, Number, Town, Postal code], <span className="font-bold">αναθέτω</span> στον/στην Διπλωματούχο Μηχανικό <span className="font-bold">( Owners Surname  ,
                            Owner's Name, Specialty Owner AM TEE)</span>
                    </p>
