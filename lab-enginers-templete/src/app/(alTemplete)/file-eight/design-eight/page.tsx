        ...
        <div className="p-4 text-sm ">
          <p className="">
            <span className="font-semibold">
              δεν προβλέπεται παραγωγή ΑΕΚΚ,
            </span>{" "}
            καθώς οι εργασίες αφορούν αποκλειστικά κοπή δέντρων και η διαχείριση
            των υπολειμμάτων (κορμοί – κλαδιά) θα γίνει σύμφωνα με τις οδηγίες
            του Δήμου, ως πράσινα οργανικά απόβλητα.»
          </p>
        </div>
