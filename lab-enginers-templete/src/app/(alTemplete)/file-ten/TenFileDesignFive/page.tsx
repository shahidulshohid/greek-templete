...
export default function TenFileDesignFive() {
    const descriptions = [
        {
            "id": 1,
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 bg-white space-y-8">
                  ...
                  <div>
                    ...
                    <div className="">
                        <div className="grid grid-cols-12">
                            ...
                            <div className="col-span-11 p-2 text-sm">
                                <p>
                                  1. Προσπέλαση στο εργοτάξιο, πρόσβαση στις θέσεις εργασίας:
                                  Δεν απαιτείται ιδιαίτερη μέριμνα πέραν των συνηθισμένων.
                                </p>
                               <p> 2.Κυκλοφορία οχημάτων και πεζών εντός του εργοταξίου:
                                Δεν απαιτείται ιδιαίτερη μέριμνα πέραν των συνηθισμένων.</p>
                                <p>
                                  3.Χώροι αποθήκευσης υλικών και τρόπος αποκομιδής αχρήστων:
                                Αποθήκευση στον ακάλυπτο χώρο της οικοδομής και αποκομιδή αχρήστων με μηχανικά μέσα.
                                </p>
                                <p>4.Συνθήκες αποκομιδής επικίνδυνων υλικών:Δεν θα χρησιμοποιηθούν επικίνδυνα υλικά.</p>
                                <p>
                                  5.Χώροι υγιεινής, εστίασης και πρώτων βοηθειών:
                                Θα δημιουργηθεί πρόχειρο W.C. και φαρμακείο στο ισόγειο.
                                </p>
                               <p>
                                 6.Κατασκευή ικριωμάτων:Συνήθους μορφής
                               </p>
                            </div>
                        </div>
                    </div>
