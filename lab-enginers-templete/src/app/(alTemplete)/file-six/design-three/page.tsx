...
export default function FileSixDesignThree() {
    return (
        <div className="max-w-[794px] mx-auto p-4 bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm ">
                    <p className="mb-6">
                        <span className="font-bold"> Οι προβλεπόμενες επεμβάσεις δεν θίγουν, δεν επηρεάζουν και δεν επιφέρουν
                            καμία τροποποίηση στον φέροντα οργανισμό (Φ.Ο.) του κτιρίου,</span> όπως αυτός έχει
                        κατασκευαστεί βάσει της εγκεκριμένης οικοδομικής άδειας και των εκάστοτε εγκεκριμένων στατικών μελετών.
                    </p>
                    <p className="mb-6">
                       <span className="font-bold"> Οι επεμβάσεις δεν αντίκεινται σε ειδικότερες διατάξεις,</span> που αφορούν στατικά, πυροπροστασία, υγιεινή,
                        προσβασιμότητα, ενεργειακή απόδοση, προστασία πολιτιστικής κληρονομιάς ή οποιονδήποτε άλλον
                        τομέα ειδικής νομοθεσίας που σχετίζεται με τις κατασκευές.
                    </p>
                </div>
