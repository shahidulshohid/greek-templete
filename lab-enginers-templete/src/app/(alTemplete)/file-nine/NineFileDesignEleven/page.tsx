      ...
      <div className="border border-gray-400">
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="flex-1 p-2">Fathers name and surname Engineer</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="flex-1 p-2">Mothers name and surname Engineer</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="flex-1 p-2">Born date</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="flex-1 p-2 ">Born Town </div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="w-32 p-2 border-r border-gray-400 ">ID</div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="w-32 p-2 border-r border-gray-400 ">Town</div>
            <div className="w-24 p-2 border-r border-gray-400 text-sm">Οδός</div>
            <div className="w-40 p-2 border-r border-gray-400 ">Address</div>
            <div className="w-24 p-2 border-r border-gray-400 text-sm">Αριθ</div>
            <div className="w-28 p-2 border-r border-gray-400">Number</div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="flex-1 p-2 ">VAT engineer</div>
        ...
        <div className="p-4 text-sm">
          ...
          <p className="mb-4">
            ότι εφαρμόζοντας τις ισχύουσες γενικές και ειδικές πολεοδομικές διατάξεις αναλαμβάνω για το έργο
          </p>
          ...
          <div className="flex justify-end p-4">
            <div className="text-right space-y-2">
              ...
              <div className="text-sm mt-8">
                <div className='mr-29'>( Υπογραφή )</div>
                <div className="mt-4 mr-29">Ο/Η Δηλών</div>
                <StampComponent
...
export default NineFileDesignEleven