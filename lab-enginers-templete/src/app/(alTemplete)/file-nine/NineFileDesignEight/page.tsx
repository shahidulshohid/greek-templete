...
export default function NineFileDesignEight() {
            ...
            <div className="space-y-6 ml-6">
                {workItems.map((item, index) => (
                   ...
                   {/* <p className="ml-7 text-sm mb-20"><span className="font-bold">
                    ...
                    <p className="font-bold mb-4"> Άρθρο 4, ΥΑ ΦΕΚ Β' 1843/2020</p>
                    <p className="font-bold">1.Αντικείμενο Εργασιών:</p>
                    <p className="mb-8">Αντικείμενο της παρούσας τεχνικής έκθεσης είναι η εκτέλεση εργασιών που απαιτούνται για τη λειτουργική συνένωση δύο υφιστάμενων οριζόντιων ιδιοκτησιών, εντός του ιδίου κτιρίου, χωρίς να τροποποιείται ο φέρων οργανισμός, ο όγκος ή η εξωτερική γεωμετρία του κτιρίου, σύμφωνα με τις διατάξεις του άρθρου 29 του Ν.4495/2017 και της ΥΑ ΦΕΚ Β' 1843/2020.</p>
                    <p className="mb-10">Η συνένωση αφορά (π.χ. δύο διαμερισμάτων του ιδίου ορόφου / ή χώρων κύριας και βοηθητικής χρήσης που ανήκουν στον ίδιο ιδιοκτήτη).</p>

                    <div>
                        <p className="font-bold">2.Αντικείμενο Εργασιών:</p>
                    <p className="mb-5">Η ανάγκη εκτέλεσης των εργασιών προκύπτει από την πρόθεση του ιδιοκτήτη να δημιουργήσει έναν ενιαίο λειτουργικό χώρο, εξυπηρετώντας καλύτερα τις ανάγκες κατοίκησης ή χρήσης του ακινήτου.</p>.
                    <p className="mb-16">Η συνένωση γίνεται χωρίς επεμβάσεις στον φέροντα οργανισμό, χωρίς αλλαγή εξωτερικής όψης, χωρίς μεταβολή επιφανειών, όγκου ή γεωμετρίας του κτιρίου.</p>
                    </div>

                   <p className="font-bold">3. Δήλωση Συμμόρφωσης – Πολεοδομική Νομιμότητα
</p>
                   <p className="mb-4">Δηλώνεται ότι οι προτεινόμενες εργασίες:
</p>

                   <p className="mb-4">● Δεν θίγουν ή τροποποιούν τον φέροντα οργανισμό του κτιρίου
</p>

                   <p className="mb-4">● Δεν αυξάνουν τον όγκο, το ύψος ή τη γεωμετρία του κτιρίου
</p>

                   <p className="mb-4">● Δεν μεταβάλλουν τις όψεις του κτιρίου
</p>
                    <p className="mb-8">● Δεν παραβιάζουν τις ισχύουσες πολεοδομικές διατάξεις</p>

                    <p>Εκτελούνται σύμφωνα με το άρθρο 29 του Ν.4495/2017 και το άρθρο 4 της ΥΑ ΦΕΚ Β’ 1843/2020.</p>
