        ...
        <div className="p-4 text-sm ">
          ...
          <p className="mt-3">
            ...
            <span className="font-semibold">
              Η παρούσα δήλωση εκδίδεται για την κάλυψη των απαιτήσεων της
              Άδειας Μικρής Κλίμακας, σύμφωνα με τις διατάξεις του Ν.4495/2017,
              καθώς και των ισχυουσών κανονιστικών και υγειονομικών διατάξεων.
            </span>
          </p>
        </div>
