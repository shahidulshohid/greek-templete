...
export default function FileThirteenDesignTwo() {
  const descriptions = [
    {
      id: 1,
        ...
        <div>
          ...
          <div className="border-b border-gray-400">
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-11 p-2 text-sm">
                Ειδικοί κίνδυνοι του παραρτ. ΙΙΙ του ΠΔ 305/96 (πλην &1) δεν
                υπάρχουν.
              </div>
            </div>
          </div>
        ...
        <div className="p-4">
          ...
          <div className="space-y-2 text-sm mt-4">
            ...
            <p>
              ...
              <span className="p-4">
                Αποθήκευση στον ακάλυπτο χώρο της οικοδομής και αποκομιδή
                αχρήστων με μηχανικά μέσα.
              </span>
            </p>
            <p>
              ...
              <span className="p-4">
                {" "}
                Δεν θα χρησιμοποιηθούν επικίνδυνα υλικά.
              </span>
            </p>
            <p>
              ...
              <span className="p-4">
                {" "}
                Θα δημιουργηθεί πρόχειρο W.C. και φαρμακείο στο ισόγειο.
              </span>
            </p>
            <p>
              6. Κατασκευή ικριωμάτων: <br />
              <span className="p-4">
                 Συνήθους μορφής βάσει Π.Δ. 778/80 και Π.Δ.
                1073/81.{" "}
              </span>
            </p>
          </div>
