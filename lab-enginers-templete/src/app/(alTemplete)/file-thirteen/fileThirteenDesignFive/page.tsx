export default function FileThirteenDesignFive() {
  return (
      ...
      <div className="border border-gray-400">
        ...
        <div className="p-4 text-sm">
          ...
          <p className="mb-4">
            ...
            Διπλωματούχο Μηχανικό <span className="font-semibold">( Engineers Surname , Engineer's Name,
            Specialty Engineer AM TEE)</span>
          </p>
