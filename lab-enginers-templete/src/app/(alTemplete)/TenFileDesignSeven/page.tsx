...
export default function TenFileDesignSeven() {

    const workItems = [
        {

            title: "Κατεδάφιση/Αποξήλωση Υφιστάμενων Τοιχοπληρώσεων (μη φερόντων στοιχείων)",
            description:
                "Τοπική καθαίρεση τμημάτων εξωτερικών τοιχοποιιών (οπτοπλινθοδομές ή άλλα υλικά πλήρωσης), χωρίς επέμβαση στον φέροντα οργανισμό (π.χ. δοκούς, υποστυλώματα).",
        ...
        {
            title: " Μετατόπιση ή Τροποποίηση Υφιστάμενων Ανοιγμάτων",
            description:
        ...
        {
            title: "Αποκατάσταση Όψεων/ Εξωτερικοί χρωματισμοί επί των όψεων",
            description:
